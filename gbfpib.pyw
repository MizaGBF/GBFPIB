...
class PartyBuilder():
    ...
    def make_party(self, ds, imgs, export):
        ...
        print("|--> Job has auxiliary weapon?:", export['aux'] > 1)
        # class
    ...
    def make_weapon(self, ds, imgs, export):
        ...
        for i in range(0, len(export['w'])):
            ...
            # skin
            if i <= 1 and export['wsm'][i] is not None and i < export['aux']:
